...
function drawTitle(){
  ...
  textSize(18); fill(245,178,120); text("v0.8.1 Black Screen Fix",width/2,height/2+4);
...
async function initCamera(){
  try{
    const visionModule = await import("https://cdn.jsdelivr.net/npm/@mediapipe/tasks-vision@0.10.18");
